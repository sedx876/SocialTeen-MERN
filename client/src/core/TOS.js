...
const TermsOfService = () => {
    return (
      <div>
				...
				<p>This Website is not for use by any persons under the age of 13 , 
					and you must not use this if under the age of 13.
				</p>

				<h5><strong>2. Intellectual Property Rights</strong></h5>
				<p>Other than content you own, which you may have opted to include 
					on this Website, under these Terms, [Sender.Company] and/or its 
				...
				<h5><strong>3. Restrictions</strong></h5>
				<p><strong>You are expressly and emphatically restricted from all 
					...
					by you and [Sender.Company] may further restrict access by 
				...
				<h5><strong>4. Your Content</strong></h5>
				<p>In these Website Standard Terms And Conditions, 
					...
					[Sender.Company] a non-exclusive, worldwide, irrevocable, 
					royalty-free, sublicensable license to use, reproduce, adapt, 
					publish, translate and distribute it in any and all media.
				</p>

				<p>Your Content must be your own and must not be infringing on any 
					third party’s rights. [Sender.Company] reserves the right to 
					remove any of Your Content from this Website at any time, and 
					for any reason, without notice.
				</p>

				<h5><strong>5. No Warranties</strong></h5>
				<p>This Website is provided “as is,” with all faults, 
					and [Sender.Company] makes no express or implied representations 
				...
				<h5><strong>6. Limitation of Liability</strong></h5>
				<p>In no event shall [Sender.Company] , nor any of its officers, 
					...
					and [Sender.Company] , including its officers, directors and 
				...
				<h5><strong>7. Indemnification</strong></h5>
				<p>You hereby indemnify to the fullest extent [Sender.Company] from 
				...
				<h5><strong>8. Severability</strong></h5>
				<p>If any provision of these Terms is found to be unenforceable or 
				...
				<h5><strong>9. Variation of Terms</strong></h5>
				<p>[Sender.Company] is permitted to revise these Terms at any time 
				...
				<h5><strong>10. Assignment</strong></h5>
				<p>[Sender.Company] shall be permitted to assign, transfer, and 
				...
				<h5><strong>11. Entire Agreement</strong></h5>
				<p>These Terms, including any legal notices and disclaimers 
					contained on this Website, constitute the entire agreement 
					between [Sender.Company] and you in relation to your use of this 
					Website, and supersede all prior agreements and understandings 
					with respect to the same.
				</p>

				<h5><strong>12. Governing Law & Jurisdiction</strong></h5>
				<p>These Terms will be governed by and construed in accordance with 
